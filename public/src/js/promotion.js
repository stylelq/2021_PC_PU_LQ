...
function changeSlideColor() {
    ...
    if ((this.value > 0) && (this.value <= 25)) { // Butter Yellow
        swiper.slideTo(1, 0, false);
    } else if ((this.value > 25) && (this.value <= 50)) {  // Strawberry
        swiper.slideTo(2, 0, false);
    } else if ((this.value > 50) && (this.value <= 75)) {  // Lavender
        swiper.slideTo(3, 0, false);
    } else if ((this.value > 75) && (this.value <= 100)) {  // Powder Blue
