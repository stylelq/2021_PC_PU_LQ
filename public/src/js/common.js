    ...
    if ($('.main-banner2').length > 0 && $('.main-banner2__item').length > 1) {
        var mainBannerProgressbarOpt = {
            ...
            beforeTransitionStart: function beforeTransitionStart() {
                if ($('.main-banner2__item').find('.swiper-slide-active').data('bg') === 'white') {
                    $('.main-banner2__progressbar').removeClass('is-black');
                    $('.main-banner2__progressbar').addClass('is-white');
                } else {
                    $('.main-banner2__progressbar').removeClass('is-white');
                    $('.main-banner2__progressbar').addClass('is-black');
                }
            }
        };
        var mainBannerOption = {
