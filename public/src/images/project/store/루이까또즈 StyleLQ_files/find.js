...
window.addEventListener('DOMContentLoaded',function(){
    ...
    const location = document.querySelector(".js-target-move").offsetTop;
    const headerH = 100; //gnb높이
    const scrollMove = location - headerH;
    if(hash != ""){
        window.scrollTo({top:scrollMove, left:0, behavior:'smooth'});
    }
    ...
    function showLoad(){
        const loadMotionAll = document.querySelectorAll('.js-load-motion');
